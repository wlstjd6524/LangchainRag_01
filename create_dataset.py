...
examples = [
    ...
    {
        "inputs": {"question": "이번 달 행사 준비를 위해 '육상 출장'으로 500km를 이동했고, 추가로 행사장 공사로 '2종 포틀랜드 시멘트' 1,500kg을 썼어. 총 탄소 배출량을 각각 구하고 최종 합산해 줘."},
        "outputs": {
            "reference": "육상 출장은 53.873 kg CO2e (계수 0.107746), 2종 포틀랜드 시멘트는 1,469.772 kg CO2e (계수 0.979848) 이며, 최종 합산 배출량은 1,523.645 kg CO2e 가 도출되어야 합니다."
        }
    }
]
